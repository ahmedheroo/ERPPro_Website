    ...
    <section id="demo" className="py-20 bg-light-gray">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-secondary mb-4 fade-in">See ERP Pro in Action</h2>
          <p className="text-gray-600 fade-in" style={{ transitionDelay: '0.2s' }}>
            A clean and intuitive dashboard that brings all your data together.
          </p>
        </div>
